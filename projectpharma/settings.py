"""
Django settings for projectpharma project on Heroku. For more info, see:
...
SECRET_KEY = "wx%dk&gi#1o@dhinvzr5&ryjczu90tj=b#f67idzjom-+4*0*b"
...
ROOT_URLCONF = 'projectpharma.urls'
